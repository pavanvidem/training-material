  ...
  - section: "Machine Learning"
    ...
    tutorials:
      - name: machinelearning
        topic: statistics
      - name: flexynesis_classification
        topic: statistics

...
> >    - {% icon param-file %} *"Modelo genético de referencia `Convert GTF to BED12 on data N: BED12` (salida de **Convert GTF to BED12** {% icon tool %})
> > 
...
>        - En *"Factor "*:
>           - *"Especifique un nombre de factor, por ejemplo efectos_fármaco_x o cáncer_marcadores "*: `Treatment`
>           - En *"1: Nivel de factor "*:
>               - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `treated`
>               - En *"Count file(s) "*: `Select all the treated count files (GSM461179, GSM461180, GSM461181)`
>           - En *"2: Nivel de factor "*:
>               - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `untreated`
>               - En *"Count file(s) "*: `Select all the untreated count files (GSM461176, GSM461177, GSM461178, GSM461182)`
>       - {% icon param-repeat %} *"Factor de inserción
>           - *"Especifique un nombre de factor, por ejemplo efectos_fármaco_x o cáncer_marcadores "*: `Sequencing`
>               - En *"Nivel de factor "*:
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `PE`
>                        - En *"Count file(s) "*: `Select all the paired-end count files (GSM461177, GSM461178, GSM461180, GSM461181)`
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `SE`
>                        - En *"Count file(s) "*: `Select all the single-end count files (GSM461176, GSM461179, GSM461182)`
>    - *"¿Los archivos tienen cabecera? "*: `Yes`
>    - *"Elección de los datos de entrada "*: `Count data (e.g. from HTSeq-count, featureCounts or StringTie)`
>    - En *"Opciones avanzadas "*:
>        - *"Use beta priors "*: `Yes`
>    - En *"Opciones de salida "*:
>        - *"Selector de salida "*: `Generate plots for visualizing the analysis results`, `Output normalised counts`
> 
{: .hands_on}
...
>         - En *"1: Sustitución "*
>            - *"Buscar patrón "*: `(.*)_(.*)_(.*)`
>            - *"Reemplazar por "*: `\1_\2_\3\tgroup:\2\tgroup:\3`
> 
...
> 
> 1. {% tool [DESeq2](toolshed.g2.bx.psu.edu/repos/iuc/deseq2/deseq2/2.11.40.8+galaxy0) %} con los siguientes parámetros:
>    - *"cómo "*: `Select group tags corresponding to levels`
...
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `treated`
>                        - *"Seleccionar grupos que correspondan a este nivel de factor "*: `Tags: treat`
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `untreated`
>                        - *"Seleccionar grupos que correspondan a este nivel de factor "*: `Tags: untreat`
>            - {% icon param-repeat %} *"Factor de inserción
>                - *"Especifique un nombre de factor, por ejemplo efectos_fármaco_x o cáncer_marcadores "*: `Sequencing`
>                - En *"Nivel de factor "*:
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `PE`
>                        - *"Seleccionar grupos que correspondan a este nivel de factor "*: `Tags: paired`
>                    - {% icon param-repeat %} *"Nivel del factor de inserción "*
>                        - *"Especifique un nivel de factor, los valores típicos podrían ser 'tumor', 'normal', 'tratado' o 'control'*: `SE`
>                        - *"Seleccionar grupos que correspondan a este nivel de factor "*: `Tags: single`
>    - *"¿Los archivos tienen cabecera? "*: `Yes`
>    - *"Elección de los datos de entrada "*: `Count data (e.g. from HTSeq-count, featureCounts or StringTie)`
>    - En *"Opciones avanzadas "*:
>        - *"Use beta priors "*: `Yes`
...
>    - *"Seleccionar líneas de "*: `Extract element identifiers on data XXX` (salida de **Extract element identifiers** {% icon tool %})
>    - *"que "*: `Match`
>    - *"Expresión regular "*: `untreat`
> 
...
> >   - {% icon param-file %} *"Filtro "*: el `DESeq2 result file` (salida de **DESeq2** {% icon tool %})
> >   - *"Con la siguiente condición "*: `c1 == "FBgn0261552"`
> > 
...
>    - *"Tipo de archivo de entrada "*: `DESeq2/edgeR/limma`
>    - {% icon param-file %} *"Anotación de referencia en formato GFF/GTF "*: imported gtf `Drosophila_melanogaster.BDGP6.32.109_UCSC.gtf.gz`
> 
{: .hands_on}
...
>    - *"Con la siguiente condición "*: `c7<0.05`
>    - *"Número de líneas de cabecera a omitir "*: `1`
> 
...
>    - *"Con la siguiente condición "*: `abs(c3)>1`
>    - *"Número de líneas de cabecera a omitir "*: `1`
> 
...
>    - *"Cortar columnas "*: `c1-c8`
>    - *"Delimitado por "*: `Tab`
>    - {% icon param-file %} *"De "*: el conjunto de datos unido (resultado de **Join two Datasets** {% icon tool %})
> 
...
>    - *"Transformación de datos "*: `Log2(value+1) transform my data`
>    - *"Activar agrupación de datos "*: `Yes`
>    - *"Etiquetado de columnas y filas "*: `Label columns and not rows`
>    - *"Tipo de mapa de colores a utilizar "*: `Gradient with 2 colors`
> 
{: .hands_on}
...
> 3. ¿Qué cambia si regenera el mapa de calor, esta vez seleccionando `Plot the data as it is` en *"Transformación de datos "*?
> 4. ¿Por qué no podemos utilizar `Log2(value) transform my data` en *"Transformación de datos "*?
...
> >      - {% icon param-file %} *"Tabla "*: `Normalized counts file on data ... and others` (salida de **DESeq2** {% icon tool %})
> >      - *"Tipo de operación de la tabla "*: `Perform a full table operation`
> >        - *"Operación "*: `Custom`
...
> >      - Haga clic en {% icon param-repeat %} *"Insertar tablas "*
> >      - En *"1: Tablas "*:
> >        - {% icon param-file %} *"Tabla "*: `Normalized counts file on data ... and others` (salida de **DESeq2** {% icon tool %})
> >      - Haga clic en {% icon param-repeat %} *"Insertar tablas "*
> >      - En *"2: Tablas "*:
> >        - {% icon param-file %} *"Table "*: salida del primer **Table Compute** {% icon tool %}
> >      - *"Expresión personalizada en 'tablaN'*: `table2.div(table1.std(1),0)`
> > 
...
> 1. {% tool [heatmap2](toolshed.g2.bx.psu.edu/repos/iuc/ggplot2_heatmap2/ggplot2_heatmap2/3.1.3.1+galaxy0) %} para trazar el mapa de calor:
>    - {% icon param-file %} *"Input should have column headers "*: `Normalized counts for the most differentially expressed genes`
>    - *"Transformación de datos "*: `Plot the data as it is`
>    - *"Compute z-scores prior to clustering "*: `Compute on rows`
>    - *"Activar agrupación de datos "*: `Yes`
>    - *"Etiquetado de columnas y filas "*: `Label columns and not rows`
>    - *"Tipo de mapa de colores a utilizar "*: `Gradient with 3 colors`
> 
{: .hands_on}
...
>    - {% icon param-file %} *"Archivo de entrada "*: el `DESeq2 result file` (salida de **DESeq2** {% icon tool %})
>    - En *"Expresiones "*:
>      - {% icon param-text %} *"Añadir expresión "*: `bool(float(c7)<0.05)`
>      - {% icon param-select %} *"¿Modo de la operación? `Append`
>    - En *"Tratamiento de errores "*:
>      - {% icon param-toggle %} *"Autodetectar tipos de columnas "*: `No`
>      - {% icon param-select %} *"Si no se puede calcular una expresión para una fila "*: `Fill in a replacement value`
>      - {% icon param-select %} *"Valor de sustitución "*: `False`
> 
> 2. {% tool [Cut](Cut1) %} columnas de una tabla con los siguientes parámetros:
>    - *"Cortar columnas "*: `c1,c8`
>    - *"Delimitado por "*: `Tab`
...
>    - *"Archivo de genes expresados diferencialmente "*: `Gene IDs and differential expression`
>    - *"Gene lengths file "*: `Gene IDs and length`
>    - *"Categorías de genes "*: `Get categories`
>       - *"Seleccionar un genoma para utilizar "*: `Fruit fly (dm6)`
>       - *"Select Gene ID format "*: `Ensembl Gene ID`
>       - *"Seleccione una o más categorías "*: `GO: Cellular Component`, `GO: Biological Process`, `GO: Molecular Function`
>    - En *"Opciones de salida "*
>      - *"¿Programa de salida de los principales términos GO? `Yes`
>      - *"¿Extraer los genes DE para las categorías (términos GO/KEGG)? "*: `Yes`
> 
{: .hands_on}
...
>       - *"Seleccionar un genoma para utilizar "*: `Fruit fly (dm6)`
>       - *"Select Gene ID format "*: `Ensembl Gene ID`
>       - *"Seleccione una o más categorías "*: `KEGG`
>    - En *"Opciones de salida "*
>      - *"¿Gráfico de salida de los principales términos GO? `No`
>      - *"¿Extraer los genes DE para las categorías (términos GO/KEGG)? "*: `Yes`
> 
{: .hands_on}
...
>    - *"Número de rutas a trazar "*: `Multiple`
>      - {% icon param-file %} *"KEGG pathways "*: `KEGG pathways to plot`
>      - *"¿Tiene el fichero cabecera (una primera línea con los nombres de las columnas)? "*: `No`
>    - *"Especies a utilizar "*: `Fly`
>    - *"¿Proporcionar un archivo de datos de genes?*: `Yes`
>      - {% icon param-file %} *"Gene data "*: `Genes with significant adj p-value and their Log2 FC`
>      - *"¿Tiene el fichero cabecera (una primera línea con los nombres de las columnas)? "*: `Yes`
>      - *"Formato para datos genéticos "*: `Ensembl Gene ID`
>    - *"¿Proporcionar un archivo de datos compuesto? "*: `No`
>    - En *"Opciones de salida "*
>      - *"Output for pathway "*: `KEGG native`
>        - *"¿Plotear en la misma capa? "*: `Yes`
> 
{: .hands_on}
...
>     - *"Modo de operación "*: `Prepare annotation`
>       - {% icon param-file %} *"Archivo GTF "*: `Drosophila_melanogaster.BDGP6.32.109_UCSC.gtf.gz`
> 
...
>     - *"Modo de operación "*: `Count reads`
>       - {% icon param-files %} *"Archivo bam de entrada "*: los archivos `BAM` generados por **RNA STAR**
>       - {% icon param-file %} *"DEXSeq compatible GTF file "*: el archivo GTF generado por **DEXSeq-Count**
>       - *"Is library paired end? "*: `Yes`
>       - *"¿Es específica la cadena de la biblioteca?*: `No`
>       - *"Omitir todas las lecturas con una calidad de alineación inferior al valor mínimo dado "*: `10`
> 
{: .hands_on}
...
>    - En *"Factor "*:
>       - En "1: Factor"
>           - *"Especifique un nombre de factor "*: `condition`
>           - En *"Nivel de factor "*:
>               - En *"1: Nivel de factor "*:
>                   - *"Especificar un nivel de factor "*: `treated`
>                   - {% icon param-files %} *"Counts file(s) "*: los 3 ficheros de recuento de exones con `treated` en su nombre
>               - En *"2: Nivel de factor "*:
>                   - *"Especificar un nivel de factor "*: `untreated`
...
>       - En "2: Factor"
>           - "Especifique un nombre de factor" a `sequencing`
>           - En *"Nivel de factor "*:
>               - En *"1: Nivel de factor "*:
>                   - *"Especificar un nivel de factor "*: `PE`
>                   - {% icon param-files %} *"Counts file(s) "*: los 4 ficheros de recuento de exones con `paired` en su nombre
>               - En *"2: Nivel de factor "*:
>                   - *"Especificar un nivel de factor "*: `SE`
...
5. Logaritmo (en base 2) del cambio de pliegue
   ...
   Los cambios de pliegue log2 se basan en el nivel de factor primario 1 frente al nivel de factor 2. El orden de los niveles del factor es entonces importante. Por ejemplo, para el factor "Condición", DESeq2 calcula los cambios de pliegues de las muestras "tratadas" frente a las "no tratadas", *es decir* los valores corresponden a la regulación al alza o a la baja de los genes en las muestras tratadas.

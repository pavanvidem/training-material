...
>        --- a/group_vars/galaxyservers.yml
>        +++ b/group_vars/galaxyservers.yml
>        @@ -298,3 +298,22 @@ galaxy_tus_upload_store: /data/tus
>         #Redis
>         galaxy_additional_venv_packages:
>           - redis
>        +
